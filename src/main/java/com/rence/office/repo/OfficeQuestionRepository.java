...
public interface OfficeQuestionRepository extends JpaRepository<OfficeQuestionEntity, Object> {
	...
	public List<OfficeQuestionEntity> select_all_comment(String backoffice_no, Integer start_row, Integer end_row);
	
	
	@Query(nativeQuery = true, 
			value="select * from question_list_view where mother_no=?1")
	public OfficeQuestionEntity select_one_answer(String comment_no);
