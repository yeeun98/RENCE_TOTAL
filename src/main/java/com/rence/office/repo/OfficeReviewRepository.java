...
public interface OfficeReviewRepository extends JpaRepository<OfficeReview_ViewEntity, Object> {
	...
	public List<OfficeReview_ViewEntity> select_all_review(String backoffice_no, Integer start_row, Integer end_row);
