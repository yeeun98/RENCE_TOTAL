...
public interface ReserveRepository extends JpaRepository<ReserveListViewEntity, Object> {
	...
	// 예약 관리 - 리스트(전체)
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state !='false' and rownum between ?2 and ?3")
	...
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state in ('begin', 'in_use') and rownum between ?2 and ?3")
	...
	// 예약 관리 - 리스트(종료) end
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state = 'end' and rownum between ?2 and ?3")
	...
	// 예약 관리 - 리스트(취소) cancel
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state = 'cancel' and rownum between ?2 and ?3")
	...
	// 예약 관리 - 리스트(전체 검색) 
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state !='false' and user_name like ?4 and rownum between ?2 and ?3")
	...
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state in ('begin', 'in_use') and user_name like ?4 and rownum between ?2 and ?3")
	...
	// 예약 관리 - 리스트(종료 검색) end
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state = 'end' and user_name like ?4 and rownum between ?2 and ?3")
	...
	@Query(nativeQuery = true, value="select * from reserve_list_b_view where backoffice_no=?1 and reserve_state = 'cancel' and user_name like ?4 and rownum between ?2 and ?3")
