...
public interface BackOfficeListRepository extends JpaRepository<BackOfficeListEntity, Object> {
	...
	public List<BackOfficeListEntity> selectAll_backoffice_apply(Integer start_row, Integer end_row);
	...
	public List<BackOfficeListEntity> selectAll_backoffice_end(Integer start_row, Integer end_row);
